    ...
    render() {
        ...
        return (
            <div>
               ...
               <div>
               <img className="imagec" src='https://th.bing.com/th/id/OIP.cMX4stKPkldmj61tP7Yl6AHaE-?w=271&h=182&c=7&o=5&dpr=1.25&pid=1.7'></img>
               </div>
               <h1 id="heading2Id">This is a section on Bass Fish</h1>
               <p className="para3">Every Fish in the nature lives only in the water And Fishes breath liquid oxen for servive their lives</p>
               <p className="para3">As the name suggests, Yes it is all about Fish Tank. We believe in the power of sharing knowledge. 
                   ...
                   The name "bonytongues" is derived from a toothed bone on the floor of the mouth, the "tongue",
                    equipped with teeth that bite against teeth on the roof of the mouth. The arowana is a facultative air breather
                     and can obtain oxygen from air by sucking it into its swim bladder, which is lined with capillaries like
                      lung tissue.</p>
                <p id="homepage4Id">As the name suggests, Yes it is all about Fish Tank. We believe in the power of sharing knowledge. 
                 Keeping a healthy aquarium is not that easy as presumed by the majority,
                 Hence we aimed to educate amateur fish keepers on how to set up fish tank.
                 There are four main types of fish tank setups. 
